...
<div class="news-list-page">
    <h2 class="news-list-page__title">NEWS LIST</h2>
    <div class="news-list">
        <ul class="news-list__tab">
            <li class="news-list__tab-item --current"><a href="<?php echo esc_url(home_url('news-list')); ?>" class="news-list__tab-link">すべて</a></li>
