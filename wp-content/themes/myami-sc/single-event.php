            ...
            <div class="page-body event-single__body">
                <div class="event-single__container">
                    <div class="event-single__upper">
                        ...
                        $thumbnail = '<div class="thumbnail"><img class="img" src="' . $thumbnail_url . '" alt="イベントイメージ"></div>';
                        echo $thumbnail
                        ?>
                    </div>
                                ...
                                <div class="detail --right">
                                    <dl>
                                        <dd>
                                            ...
                                            $location = esc_url(get_theme_file_uri('assets/images/location/location01.jpg'));
                                            $location2 = esc_url(get_theme_file_uri('assets/images/location/location02.jpg'));
                                            $location3 = esc_url(get_theme_file_uri('assets/images/location/location03.jpg'));


                                            if ($venue === "C入口丸柱") {
                                                echo '<img  class="img" src="' . $location . '" alt="ロケーションイメージ">';
                                            }
                                            if ($venue === "ポケットパーク") {
                                                echo '<img  class="img" src="' . $location2 . '" alt="ロケーションイメージ">';
                                            };
